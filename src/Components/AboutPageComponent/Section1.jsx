    ...
    <div className="w-full h-auto flex flex-col mt-20 md:mt-24 xl:mt-32 gap-5 md:flex-row-reverse md:justify-between">
      <div className="w-full h-auto flex flex-col gap-2 md:w-[50%]">
        <div className="w-auto h-auto flex flex-col">
          <span className="font-dmSans font-[500] text-[#0159A5]">
            About Us
          </span>
          <div className="w-auto h-5 flex items-center relative">
            ...
            <LuMoveRight
              size={25}
              className="absolute left-[56px] text-[#0159A5]"
            />
          </div>
        </div>
        <div className="w-full h-auto flex flex-col gap-3 sm:gap-5 md:gap-3 lg:gap-5 lg:mb-5 xl:gap-6 xl:mb-8">
          <h1 className="text-2xl font-bold text-[#292833] font-jakarta sm:text-5xl md:text-3xl lg:text-4xl xl:text-5xl">
            Financial Tax & <span className="text-[#0159A5]">Strategic</span>{" "}
            Fields
          </h1>
          <p className="text-[#292833] font-dmSans text-sm sm:text-base md:text-sm lg:text-base xl:text-lg">
        ...
        <div className="w-full h-auto flex flex-col gap-2 sm:items-center sm:flex-row sm:gap-4 md:flex-col md:justify-start lg:flex-row">
          <div className="w-full h-full flex sm:w-auto md:h-auto md:w-full lg:w-auto">
            <NavLink
              to="/"
              className="bg-[#08AABD1A] text-[#292833] border border-[#0159A5] font-[500] font-dmSans px-3 py-2 rounded-xl flex gap-3 items-center active:bg-[#08abbd3d] cursor-pointer md:hover:bg-[#08abbd3d] md:py-2 xl:px-5 xl:text-lg"
            >
              Free Consultation <LuMoveRight size={20} />
            </NavLink>
          </div>
      ...
      <div className="w-full h-auto flex mx-auto md:w-[48%] md:mx-0 xl:w-[46%]">
        <img
          src=""
          alt=""
          className="bg-[#F1F1F9] w-full object-cover h-[300px] md:h-full"
        />
      </div>
    </div>
  );
